          ...
          <div className="w-full md:w-1/2 text-left">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-green-400 uppercase text-sm tracking-wider">Years Experience</p>
              </div>
              <div>
                <h3 className="text-4xl font-bold text-white mb-2">50+</h3>
                <p className="text-green-400 uppercase text-sm tracking-wider">Projects Completed</p>
              </div>
            </div>
          </div>
        </div>
